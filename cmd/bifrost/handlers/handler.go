...
// BifrostHandler is rest handler for Bifrost rest handler
type BifrostHandler struct {
...
func (h *BifrostHandler) Start(ctx context.Context, r *gin.Engine, defaultPort int) {
...
// @Router / [get]
func (h *BifrostHandler) HealthCheck(c *gin.Context) {
	uptime := sigar.Uptime{}
	uptime.Get()
